...
\begin{itemize}
	\item Permainan ini hanya dapat dimainkan menggunakan \textit{web browser} khususnya pada \textit{desktop} dan \textit{smartphone}.
...
\begin{enumerate}
	...
	\item Bab 4 berisikan perancangan perangkat lunak yang dibangun. Perancangan yang dilakukan meliputi diagram \textit{sequence}, diagram kelas dan \textit{mockup}.
